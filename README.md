# tmpl-mode - Minor mode for "tmpl" template files

*Author:* Anders Lindgren<br>
*Version:* 1.0.0<br>
*URL:* [https://github.com/Lindydancer/tmpl-mode](https://github.com/Lindydancer/tmpl-mode)<br>
...
---
Converted from `tmpl-mode.el` by [*el2markdown*](https://github.com/Lindydancer/el2markdown).
